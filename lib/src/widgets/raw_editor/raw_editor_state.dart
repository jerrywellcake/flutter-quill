...
class QuillRawEditorState extends EditorState
  ...
  Widget build(BuildContext context) {
    ...
    return TextFieldTapRegion(
      ...
      child: QuillBlockStyles(
        leadingBuilder: _blockLeadingBuilder,
        indentWidthBuilder: _blockIndentWidthBuilder,
        child: QuillStyles(
          data: _styles!,
          child: Shortcuts(
  ...
  void didChangeDependencies() {
    ...
    _blockLeadingBuilder = widget.configurations.blockLeadingBuilder;
    _blockIndentWidthBuilder = widget.configurations.blockIndentWidthBuilder;
